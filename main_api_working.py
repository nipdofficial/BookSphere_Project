"""
Working Book Recommendation System API
Simplified version without pandas to avoid compatibility issues
"""
...
MOCK_BOOKS = [
    {
        ...
        "description": "A comedic science fiction series about the adventures of Arthur Dent after Earth is destroyed.",
        ...
        "published_year": 1979,
        "num_pages": 193,
        "thumbnail": "https://books.google.com/books/content?id=W-xMPgAACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api",
        "large_thumbnail": "https://books.google.com/books/content?id=W-xMPgAACAAJ&printsec=frontcover&img=1&zoom=2&source=gbs_api",
        "preview_link": "https://books.google.com/books?id=W-xMPgAACAAJ&printsec=frontcover&source=gbs_api",
        "info_link": "https://books.google.com/books?id=W-xMPgAACAAJ&printsec=frontcover&source=gbs_api",
        "canonical_volume_link": "https://books.google.com/books/about/The_Hitchhiker_s_Guide_to_the_Galaxy.html?hl=&id=W-xMPgAACAAJ",
        "joy": 0.8,
        "anger": 0.1,
        "fear": 0.2,
        "sadness": 0.1,
    ...
    },
    {
        ...
        "published_year": 1813,
        "num_pages": 432,
        "thumbnail": "https://books.google.com/books/content?id=5m5VnQEACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api",
        "large_thumbnail": "https://books.google.com/books/content?id=5m5VnQEACAAJ&printsec=frontcover&img=1&zoom=2&source=gbs_api",
        "preview_link": "https://books.google.com/books?id=5m5VnQEACAAJ&printsec=frontcover&source=gbs_api",
        "info_link": "https://books.google.com/books?id=5m5VnQEACAAJ&printsec=frontcover&source=gbs_api",
        "canonical_volume_link": "https://books.google.com/books/about/Pride_and_Prejudice.html?hl=&id=5m5VnQEACAAJ",
        "joy": 0.6,
        "anger": 0.2,
        "fear": 0.1,
        "sadness": 0.3,
    ...
    },
    {
        ...
        "preview_link": "https://books.google.com/books?id=5m5VnQEACAAJ&printsec=frontcover&source=gbs_api",
        "info_link": "https://books.google.com/books?id=5m5VnQEACAAJ&printsec=frontcover&source=gbs_api",
        "canonical_volume_link": "https://books.google.com/books/about/1984.html?hl=&id=5m5VnQEACAAJ",
        "joy": 0.1,
        "anger": 0.7,
        "fear": 0.8,
        "sadness": 0.6,
    ...
    },
    {
        ...
        "categories": "Classic Literature, Social Issues",
        "simple_categories": "Fiction",
        "average_rating": 4.3,
        "ratings_count": 2800,
        "published_year": 1960,
        ...
        "preview_link": "https://books.google.com/books?id=5m5VnQEACAAJ&printsec=frontcover&source=gbs_api",
        "info_link": "https://books.google.com/books?id=5m5VnQEACAAJ&printsec=frontcover&source=gbs_api",
        "canonical_volume_link": "https://books.google.com/books/about/To_Kill_a_Mockingbird.html?hl=&id=5m5VnQEACAAJ",
        "joy": 0.3,
        "anger": 0.6,
        "fear": 0.4,
        "sadness": 0.5,
    ...
    },
    {
        ...
        "description": "A novel about the American Dream and the Jazz Age in 1920s America.",
        ...
        "preview_link": "https://books.google.com/books?id=5m5VnQEACAAJ&printsec=frontcover&source=gbs_api",
        "info_link": "https://books.google.com/books?id=5m5VnQEACAAJ&printsec=frontcover&source=gbs_api",
        "canonical_volume_link": "https://books.google.com/books/about/The_Great_Gatsby.html?hl=&id=5m5VnQEACAAJ",
        "joy": 0.4,
        "anger": 0.3,
        "fear": 0.2,
        "sadness": 0.7,
    ...
    try:
        ...
        for item in data.get('items', []):
            ...
            book = {
                ...
                'simple_categories': volume_info.get('categories', ['Fiction'])[0] if volume_info.get('categories') else 'Fiction',
...
def search_books_local(query, category="All", tone="All", top_k=20):
    """Search local mock books"""
    results = []
    query_lower = query.lower()
    
    for book in MOCK_BOOKS:
        # Filter by category
        if category != "All" and book.get('simple_categories') != category:
            continue
        
        # Filter by emotional tone
        if tone != "All":
            if tone == "Happy" and book.get('joy', 0) < 0.6:
                continue
            elif tone == "Surprising" and book.get('surprise', 0) < 0.5:
                continue
            elif tone == "Angry" and book.get('anger', 0) < 0.5:
                continue
            elif tone == "Suspenseful" and book.get('fear', 0) < 0.5:
                continue
            elif tone == "Sad" and book.get('sadness', 0) < 0.5:
                continue
...
def root():
    ...
    return jsonify({
        "message": "Book Sphere Working API Server",
        "version": "2.0.0",
        "status": "running",
        "features": [
            "Book recommendations (20+ books)",
...
def get_recommendations():
    ...
    try:
        ...
        # Get recommendations from local books
        local_recommendations = search_books_local(query, category, tone, top_k)
...
def get_personalized_recommendations():
    ...
    try:
        ...
        # Get recommendations
        recommendations = search_books_local(personalized_query, top_k=top_k)
...
if __name__ == '__main__':
    logger.info("Starting Book Sphere Working API Server")
    logger.info("Features: 20+ book recommendations, Google Books integration, Library management")
